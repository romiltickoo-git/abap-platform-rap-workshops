CLASS zcl_rap100_gen_data_rom DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_rom IMPLEMENTATION.
METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'ROM',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atravrom.

    "insert travel demo data
    INSERT zrap100_atravrom  FROM (
        SELECT
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table ZRAP100_ROM{ group_id }. | ).
  ENDMETHOD.
ENDCLASS.
